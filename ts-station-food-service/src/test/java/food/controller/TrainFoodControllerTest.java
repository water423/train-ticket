...
public class TrainFoodControllerTest {
    ...
    public void testGetAllTrainFood() throws Exception {
        Mockito.when(stationFoodService.listTrainFood(Mockito.any(HttpHeaders.class))).thenReturn(response);
    ...
    public void testGetTrainFoodOfTrip() throws Exception {
        Mockito.when(stationFoodService.listTrainFoodByTripId(Mockito.anyString(), Mockito.any(HttpHeaders.class))).thenReturn(response);
